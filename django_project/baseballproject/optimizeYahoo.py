...
def editPlayerNameYahoo(elementName, start, finish):
...
"""
def findMaxPPYahoo(playerDict, pitchers, catchers, firstBase, secondBase, thirdBase, shortStop, outfielders, teams=set(),
               lineupsViolateConstraint=set(), maxPlayer=6):
